(function (global, factory) {
	...
	(global = global || self, global.Compress = factory());
	...
	Compress.prototype.validate = function (file) {
	  var imgReg = /image\/jpeg|image\/jpg|image\/png/;
	    ...
	    try {
	      ...
	      fileReader.onload = function (e) {
	        ...
	        image.onload = function () {
	          ...
	          _this.getBase64(orientation, canvas).then(function (base64) {
	...
	Compress.prototype.getBase64 = function (orientation, canvas) {
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      detectImageAutomaticRotation().then(function (res) {
	        var isAutomaticRotation = res; // 如果是浏览器不会自动回正图片方向的iphone 则旋转方向
	        ...
	        if (navigator.userAgent.match(/iphone/i && !isAutomaticRotation)) {
	          ...
	          if (orientation !== '' && orientation !== 1) {
	            switch (orientation) {
	              case 6:
	                // 需要顺时针（向左）90度旋转
	                _this2.rotateImg(_this2, 'left', canvas);

	                break;

	              case 8:
	                // 需要逆时针（向右）90度旋转
	                _this2.rotateImg(_this2, 'right', canvas);

	                break;

	              case 3:
	                // 需要180度旋转
	                _this2.rotateImg(_this2, 'right', canvas); //转两次
...
//# sourceMappingURL=compress.min.js.map
